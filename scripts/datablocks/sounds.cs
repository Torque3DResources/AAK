...
{
   filename = "data/AAK/art/sound/player/player_footstep_sand01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerFootstepSand02)
{
   filename = "data/AAK/art/sound/player/player_footstep_sand02.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerFootstepSand03)
{
   filename = "data/AAK/art/sound/player/player_footstep_sand03.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_footstep_stone01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerFootstepStone02)
{
   filename = "data/AAK/art/sound/player/player_footstep_stone02.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerFootstepStone03)
{
   filename = "data/AAK/art/sound/player/player_footstep_stone03.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_stop.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_jump_crouch.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_jump01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerJump02)
{
   filename = "data/AAK/art/sound/player/player_jump02.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerJump03)
{
   filename = "data/AAK/art/sound/player/player_jump03.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_land01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerLand02)
{
   filename = "data/AAK/art/sound/player/player_land02.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_climb_idle.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_climb_up01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerClimbUp02)
{
   filename = "data/AAK/art/sound/player/player_climb_up02.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerClimbUp03)
{
   filename = "data/AAK/art/sound/player/player_climb_up03.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_climb_down01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerClimbDown02)
{
   filename = "data/AAK/art/sound/player/player_climb_down02.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_climb_leftright01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerClimbLeftRight02)
{
   filename = "data/AAK/art/sound/player/player_climb_leftright02.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_ledge_idle.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_ledgeup.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_ledge_leftright01.ogg";
   description = AudioClose3D;
   preload = true;
};
new SFXProfile(playerLedgeLeftRight02)
{
   filename = "data/AAK/art/sound/player/player_ledge_leftright02.ogg";
   description = AudioClose3D;
   preload = true;
};
...
{
   filename = "data/AAK/art/sound/player/player_slide.ogg";
...
{
   fileName = "data/AAK/art/sound/player/player_death01.ogg";
...
{
   fileName = "data/AAK/art/sound/player/player_pain.ogg";
   description = AudioDefault3d;
   preload = true;
};
...
{
   filename    = "data/AAK/art/sound/player/player_water_splash01.ogg";
   description = AudioDefault3d;
   preload = true;
};