...
{
	diffuseMap[0] = "data/AAK/art/shapes/actors/Maco/footprint.png";
	normalMap[0] = "data/AAK/art/shapes/actors/Maco/footprint_normal.png";
	translucent = "1";
...
singleton Material( base_maco_mat_body_diffusetex )
{
	...
	diffuseMap[0] = "data/AAK/art/shapes/actors/Maco/base_maco_mat_body_diffusetex";
...
singleton Material( cnst_maco_mat_face_diffusetex )
{
	...
	diffuseMap[0] = "data/AAK/art/shapes/actors/Maco/cnst_maco_mat_face_diffusetex";
	doubleSided = "1";	//our normals are backwards (oops!) so we turn this on
	subSurface[0] = "0";
...
singleton Material( blue_maco_mat_body_diffusetex : base_maco_mat_body_diffusetex )
{
   ...
   diffuseMap[0] = "data/AAK/art/shapes/actors/Maco/blue_maco_mat_body_diffusetex";
};
