...
// 3D position and render itself. Note that CameraBlocker handles its own
...
class CameraBlocker : public SceneObject
{
   ...
   static bool smRenderBlockers;

public:
   CameraBlocker();
   virtual ~CameraBlocker();

   // Declare this object as a ConsoleObject so that we can
   // instantiate it into the world and network it
   DECLARE_CONOBJECT(CameraBlocker);
